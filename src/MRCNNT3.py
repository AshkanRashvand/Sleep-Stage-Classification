...
class MRCNN(nn.Module):
    def __init__(self, afr_reduced_cnn_size):
        ...
        self.features3 = nn.Sequential(
            nn.Conv1d(1, 64, kernel_size=100, stride=10, bias=False, padding=50),
            nn.BatchNorm1d(64),
            self.GELU,
            nn.MaxPool1d(kernel_size=4, stride=2, padding=2),
            nn.Dropout(drate),

            nn.Conv1d(64, 128, kernel_size=10, stride=1, bias=False, padding=5),
            nn.BatchNorm1d(128),
            self.GELU,

            nn.Conv1d(128, 128, kernel_size=10, stride=1, bias=False, padding=5),
            nn.BatchNorm1d(128),
            self.GELU,
...
class AttnSleep(nn.Module):
    def __init__(self):
        ...
        self.align_layer = nn.Linear(12560, 2400)
...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("loss_plot_MRCNNT3.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("accuracy_plot_MRCNNT3.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("f1_plot_MRCNNT3.png")
    plt.close()
    ...
    plt.savefig("confusion_matrix_MRCNNT3.png")
    plt.close()
